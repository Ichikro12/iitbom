...
# Streamlit UI
st.sidebar.title("Sign Language Translation")
st.sidebar.write("Use the sign language to form a sentence. Press Enter to translate.")
st.sidebar.write("Translated Sentence:")
